                            ...
                            <div className="all__sidebar-item-post">
                                <div className="all__sidebar-item-post-item">
                                    <div className="all__sidebar-item-post-item-image">
                                        <a href="/blog-details/1"><img src="/img/blog/post-1.jpg" alt="" /></a>
                                    </div>
                                    <div className="all__sidebar-item-post-item-content">
                                        <span><i className="fal fa-calendar-alt"></i>05 June, 2023</span>
                                        <h6><a href="/blog-details/1">Book your next Trip today!</a></h6>
                                    </div>
                                </div>
                                <div className="all__sidebar-item-post-item">
                                    <div className="all__sidebar-item-post-item-image">
                                        <a href="/blog-details/2"><img src="/img/blog/post-2.jpg" alt="" /></a>
                                    </div>
                                    <div className="all__sidebar-item-post-item-content">
                                        <span><i className="fal fa-calendar-alt"></i>02 June, 2023</span>
                                        <h6><a href="/blog-details/2">Booking is an Easy way to find</a></h6>
                                    </div>
                                </div>
                                <div className="all__sidebar-item-post-item">
                                    <div className="all__sidebar-item-post-item-image">
                                        <a href="/blog-details/3"><img src="/img/blog/post-3.jpg" alt="" /></a>
                                    </div>
                                    <div className="all__sidebar-item-post-item-content">
                                        <span><i className="fal fa-calendar-alt"></i>04 June, 2023</span>
                                        <h6><a href="/blog-details/3">Book instantly And also get</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
